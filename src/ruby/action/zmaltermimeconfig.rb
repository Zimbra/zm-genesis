...
module Action # :nodoc
  #
  # Perform zmaltermimeconfig action.  This will invoke some zmaltermimeconfig with some arguments

  #
  class ZMAltermimeconfig < Action::Command
    ...
    def initialize(*arguments)
      super()
      @runner = RunCommand.new(File.join(ZIMBRAPATH,'libexec','zmaltermimeconfig'), ZIMBRAUSER, *arguments)
      @label = ''
