...
module Action # :nodoc
  #
  # Perform zmztozmig action.  This will invoke some zmztozmig with some arguments

  #
  class ZMZtozmig < Action::Command

    #
    #  Create a zmztozmig object.
    #

    attr :label, true
    def initialize(*arguments)
      super()
      @runner = RunCommandOnMailbox.new(File.join(ZIMBRAPATH,'libexec','zmztozmig'), ZIMBRAUSER, *arguments)
      @label = ''
