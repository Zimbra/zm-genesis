...
current.description = "Share folders noop test"
...
current.action = [    
                  ...
                  Action::SendMail.new(nameOneAccount.name,message.gsub(/REPLACEME/, nameOneAccount.name), mta),   
                  Action::WaitQueue.new(1200, mta),
                  NoopVerify.new(mimap, {'EXISTS' => [1]}), 
                  cb("Change Folder") do
