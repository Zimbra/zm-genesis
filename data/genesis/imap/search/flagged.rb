...
#
# IMAP SEARCH flagged test cases
#
if($0 == __FILE__)
...
current.description = "IMAP Search Flagged test"
...
# Execution
#
current.action = IMAP.genSearchAction(m, testAccount, message, :FLAGGED, 'FLAGGED', 'UNFLAGGED') 
